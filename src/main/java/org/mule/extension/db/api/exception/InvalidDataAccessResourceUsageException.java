...
public class InvalidDataAccessResourceUsageException extends NonTransientDataAccessException {
  ...
  public InvalidDataAccessResourceUsageException(String message, DatabaseErrors errorType) {
  ...
  public InvalidDataAccessResourceUsageException(String message, DatabaseErrors errorType, Throwable cause) {
