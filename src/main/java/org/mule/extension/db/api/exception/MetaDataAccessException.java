 ...
 */
public class MetaDataAccessException extends DataAccessException {

  public MetaDataAccessException(String message) {
    super(message, DATA_ACCESS_EXCEPTION);
  }

  public MetaDataAccessException(String message, DatabaseErrors errorType) {
  ...
  public MetaDataAccessException(String message, DatabaseErrors errorType, Throwable cause) {
