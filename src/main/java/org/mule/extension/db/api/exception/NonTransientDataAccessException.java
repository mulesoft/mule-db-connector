...
import static org.mule.extension.db.api.exception.DatabaseErrors.NON_TRANSIENT_DATA_ACCESS_EXCEPTION;
...
public abstract class NonTransientDataAccessException extends DataAccessException {
  ...
  public NonTransientDataAccessException(String message) {
    super(message, NON_TRANSIENT_DATA_ACCESS_EXCEPTION);
  }

  public NonTransientDataAccessException(String message, DatabaseErrors errorType) {
    super(message, errorType);
  }

  public NonTransientDataAccessException(String message, Throwable cause) {
    super(message, NON_TRANSIENT_DATA_ACCESS_EXCEPTION, cause);
  }

  public NonTransientDataAccessException(String message, DatabaseErrors errorType, Throwable cause) {
