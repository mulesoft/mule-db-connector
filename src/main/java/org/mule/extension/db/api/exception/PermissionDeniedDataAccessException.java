...
import static org.mule.extension.db.api.exception.DatabaseErrors.PERMISSION_DENIED_DATA_ACCESS_EXCEPTION;
...
public class PermissionDeniedDataAccessException extends NonTransientDataAccessException {
  ...
  public PermissionDeniedDataAccessException(String message) {
    super(message, PERMISSION_DENIED_DATA_ACCESS_EXCEPTION);
  }

  public PermissionDeniedDataAccessException(String message, DatabaseErrors errorType) {
    super(message, errorType);
  }

  public PermissionDeniedDataAccessException(String message, Throwable cause) {
    super(message, PERMISSION_DENIED_DATA_ACCESS_EXCEPTION, cause);
  }

  public PermissionDeniedDataAccessException(String message, DatabaseErrors errorType, Throwable cause) {
