...
import static org.mule.extension.db.api.exception.DatabaseErrors.PESSIMISTIC_LOCKING_FAILURE_EXCEPTION;
...
public class PessimisticLockingFailureException extends ConcurrencyFailureException {
  ...
  public PessimisticLockingFailureException(String message) {
    super(message, PESSIMISTIC_LOCKING_FAILURE_EXCEPTION);
  }

  public PessimisticLockingFailureException(String message, DatabaseErrors errorType) {
    super(message, errorType);
  }

  public PessimisticLockingFailureException(String message, Throwable cause) {
    super(message, PESSIMISTIC_LOCKING_FAILURE_EXCEPTION, cause);
  }

  public PessimisticLockingFailureException(String message, DatabaseErrors errorType, Throwable cause) {
