...
import static org.mule.extension.db.api.exception.DatabaseErrors.QUERY_TIMEOUT_EXCEPTION;
...
public class QueryTimeoutException extends TransientDataAccessException {
  ...
  public QueryTimeoutException(String message) {
    super(message, QUERY_TIMEOUT_EXCEPTION);
  }

  public QueryTimeoutException(String message, DatabaseErrors errorType) {
    super(message, errorType);
  }

  public QueryTimeoutException(String message, Throwable cause) {
    super(message, QUERY_TIMEOUT_EXCEPTION, cause);
  }

  public QueryTimeoutException(String message, DatabaseErrors errorType, Throwable cause) {
