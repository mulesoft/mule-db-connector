...
import static org.mule.extension.db.api.exception.DatabaseErrors.TRANSIENT_DATA_ACCESS_EXCEPTION;
...
public abstract class TransientDataAccessException extends DataAccessException {
  ...
  public TransientDataAccessException(String message) {
    super(message, TRANSIENT_DATA_ACCESS_EXCEPTION);
  }

  public TransientDataAccessException(String message, DatabaseErrors errorType) {
    super(message, errorType);
  }

  public TransientDataAccessException(String message, Throwable cause) {
    super(message, TRANSIENT_DATA_ACCESS_EXCEPTION, cause);
  }

  public TransientDataAccessException(String message, DatabaseErrors errorType, Throwable cause) {
