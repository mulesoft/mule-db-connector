...
import org.mule.extension.db.api.exception.CannotAcquireLockException;
import org.mule.extension.db.api.exception.CannotSerializeTransactionException;
...
import org.mule.extension.db.api.exception.DeadlockLoserDataAccessException;
import org.mule.extension.db.api.exception.DuplicateKeyException;
import org.mule.extension.db.api.exception.InvalidResultSetAccessException;
    ...
    if (this.sqlErrorCodes != null) {
      ...
      if (errorCode != null) {
        ...
        if (Arrays.binarySearch(this.sqlErrorCodes.getBadSqlGrammarCodes(), errorCode) >= 0) {
          ...
          return new BadSqlGrammarException(buildMessage(task, sql, sqlEx), sqlEx);
        } else if (Arrays.binarySearch(this.sqlErrorCodes.getInvalidResultSetAccessCodes(), errorCode) >= 0) {
          logTranslation(task, sql, sqlEx, false);
          return new InvalidResultSetAccessException(buildMessage(task, sql, sqlEx), sqlEx);
