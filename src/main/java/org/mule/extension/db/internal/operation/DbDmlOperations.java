...
import org.mule.extension.db.internal.metadata.QuerySingleMetadataResolverQueryDefinition;
import org.mule.extension.db.internal.metadata.SelectMetadataResolverQueryDefinition;
import org.mule.extension.db.internal.metadata.StoredProcedureMetadataResolverStoreProcedureCall;
...
public class DbDmlOperations implements Initialisable {
   ...
   */
  @OutputResolver(output = SelectMetadataResolverQueryDefinition.class)
  public PagingProvider<DbConnection, Map<String, Object>> select(
                                                                  @ParameterGroup(name = QUERY_GROUP) @Placement(
                                                                      tab = ADVANCED_TAB) @MetadataKeyId QueryDefinition query,
   ...
   * @since 1.9.0
   */
  @OutputResolver(output = QuerySingleMetadataResolverQueryDefinition.class)
  public Map<String, Object> querySingle(@ParameterGroup(name = QUERY_GROUP) @Placement(
      tab = ADVANCED_TAB) @MetadataKeyId QueryDefinition query, @Config AbstractDbConnector connector,
   ...
   * @throws SQLException if an error is produced
   */
  public StatementResult insert(@ParameterGroup(name = QUERY_GROUP) @Placement(
      tab = ADVANCED_TAB) @MetadataKeyId QueryDefinition query,
                                @ParameterGroup(
   ...
   * @throws SQLException if an error is produced
   */
  public StatementResult update(@ParameterGroup(name = QUERY_GROUP) @MetadataKeyId QueryDefinition query,
                                @ParameterGroup(
                                    name = AUTO_GENERATE_KEYS) DbAutoGenerateKeysAttributes autoGenerateKeysAttributes,
                                @Config AbstractDbConnector connector,
                                @Connection DbConnection connection,
   ...
   * @throws SQLException if an error is produced
   */
  public int delete(@ParameterGroup(name = QUERY_GROUP) @Placement(tab = ADVANCED_TAB) @MetadataKeyId QueryDefinition query,
                    @Config AbstractDbConnector connector,
                    @Connection DbConnection connection,
                    StreamingHelper streamingHelper)
      throws SQLException {
  ...
  @Streaming
  @OutputResolver(output = StoredProcedureMetadataResolverStoreProcedureCall.class)
  public Map<String, Object> storedProcedure(@ParameterGroup(name = QUERY_GROUP) @MetadataKeyId StoredProcedureCall call,
                                             @ParameterGroup(
                                                 name = AUTO_GENERATE_KEYS) DbAutoGenerateKeysAttributes autoGenerateKeysAttributes,
                                             @Config AbstractDbConnector connector,
                                             @Connection DbConnection connection,
