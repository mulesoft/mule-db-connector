...
public class CredentialsMaskUtils {
   ...
   *
   * @param input Url to mask
   * @return the masked URL.
   */
  public static String maskUrlUserAndPassword(String input) {
    String inputMasked = maskUrlPattern(input, ORACLE_PASSWORD, PASSWORD_MASK, PASSWORD_URL_PREFIX);
    inputMasked = maskUrlPattern(inputMasked, ORACLE_USER, USER_MASK, PASSWORD_URL_PREFIX);
    inputMasked = maskUrlPattern(inputMasked, PASSWORD_PATTERN_NO_QUOTES, PASSWORD_MASK, PASSWORD_URL_PREFIX);
    inputMasked = maskUrlPattern(inputMasked, USER_PATTERN_NO_QUOTES, USER_MASK, PASSWORD_URL_PREFIX);
    inputMasked = maskUrlPattern(inputMasked, PASSWORD_PATTERN, PASSWORD_MASK, PASSWORD_URL_PREFIX);
    return inputMasked;
  }
