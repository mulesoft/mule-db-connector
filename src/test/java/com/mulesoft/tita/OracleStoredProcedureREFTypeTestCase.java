...
@RunWith(Ambar.class)
public class OracleStoredProcedureREFTypeTestCase {
  ...
  public static ApplicationBuilder app(ApplicationSelector runtimeBuilder) {
    return runtimeBuilder
        .custom("stored-procedure-oracle-reftype-app", "tita/stored-procedure-oracle-reftype-app.xml")
        .withTemplatePomFile("tita/stored-procedure-oracle-reftype-app-pom.xml")
