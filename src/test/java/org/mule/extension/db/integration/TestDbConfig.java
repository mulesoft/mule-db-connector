...
public class TestDbConfig {
  ...
  /**
   * <strong>Developer Note:</strong> To run the MySQL tests you need to follow the following steps:
   * <ul>
   ...
   * <code>docker run -p 3306:3306 --name some-mysql -e MYSQL_ROOT_PASSWORD=mysql -d mysql:latest</code></li>
   * </ul>
   *
  ...
  /**
   * <strong>Developer Note:</strong> To run the oracle tests you need to follow the following steps:
   * <ul>
   ...
   * <li>Start the
   * container:<code>docker run -d -it --name oracle-db -p 1521:1521 store/oracle/database-enterprise:12.2.0.1</code></li>
  ...
  /**
   * <strong>Developer Note:</strong> To run the MsSQL tests you need to follow the following steps:
   * <ul>
   ...
   * <li>Start the container:
   * <code>docker run -e 'ACCEPT_EULA=Y' -e 'SA_PASSWORD=yourStrong(!)Password' -p 1433:1433 -d microsoft/mssql-server-linux</code>
   * </ul>
   *
